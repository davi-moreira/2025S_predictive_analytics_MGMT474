...
Original file is located at
    https://colab.research.google.com/github/intro-stat-learning/ISLP_labs/blob/v2.2/Ch10-deeplearning-lab.ipynb
...
from ISLP.models.model_spec import ModelSpec as MS
...
!pip install --upgrade numpy scipy torchmetrics torchinfo torchvision
