...
![](figs/contexto-add.png){width="55%"}
...
![](figs/contexto-obs.png){width="60%"}
...
![](figs/hierarquia-1.PNG){width="60%"}
...
![](figs/hierarquia-2.PNG){width="60%"}
...
![](figs/hierarquia-3.PNG){width="70%"}
...
![](figs/project-history.jpg){width="60%"}
...
![](figs/paper-abstract.jpg){width="70%"}
...
![[Template](https://jkastellec.scholar.princeton.edu/publications/using-graphs-instead-tables-political-science){target="_blank"} and [Rubric](https://www.purdue.edu/undergrad-research/conferences/spring/Rubric_Poster.pdf){target="_blank"}](figs/poster_template.png){width="70%"}
...
![](figs/how-to-write-good-02.png){width="35%"}
